...
export default function LoginForm() {
  ...
  const handleGoogleLogin = () => {
    ...
    alert('Đăng nhập Google sẽ được cập nhật sau!');
  };

  const handleFacebookLogin = () => {
    // TODO: Implement Facebook OAuth
    alert('Đăng nhập Facebook sẽ được cập nhật sau!');
  };
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors outline-none text-gray-900 placeholder-gray-400 ${
